...
if __name__ == '__main__':
    input_obj = "a_bowl.obj"
    scaled_path, mesh = rescale_obj_uniform(input_obj, "scaled_model.obj")
    ...
    save_brick_plan(plan_with_colors, "lego_plan.txt")
    save_ldr_file_vertical_flip_aligned(plan_with_colors, "bowl.ldr")
    # save_brick_to_voxels(plan_with_colors, "brick_to_voxels.txt")